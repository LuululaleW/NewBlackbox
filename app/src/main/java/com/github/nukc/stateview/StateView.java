...
public class StateView extends View {
    ...
    public StateView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, top.niunaijun.blackboxa.R.styleable.StateView);
        mEmptyResource = a.getResourceId(top.niunaijun.blackboxa.R.styleable.StateView_emptyResource, 0);
        mRetryResource = a.getResourceId(top.niunaijun.blackboxa.R.styleable.StateView_retryResource, 0);
        mLoadingResource = a.getResourceId(top.niunaijun.blackboxa.R.styleable.StateView_loadingResource, 0);
        a.recycle();

        if (mEmptyResource == 0) {
            mEmptyResource = top.niunaijun.blackboxa.R.layout.base_empty;
        }
        if (mRetryResource == 0) {
            mRetryResource = 0;
        }
